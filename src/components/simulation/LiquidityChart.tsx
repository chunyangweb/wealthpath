...
export function LiquidityChart({ points, finalLiquid, finalSemiLiquid, finalLocked }: Props) {
        ...
        <AreaChart data={chartData} margin={{ top: 8, right: 8, bottom: 0, left: 8 }}>
          <defs>
            <linearGradient id="gradLiquid" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%"  stopColor={COLOR_LIQUID_FILL} stopOpacity={0.9} />
              <stop offset="95%" stopColor={COLOR_LIQUID_FILL} stopOpacity={0.65} />
            </linearGradient>
            <linearGradient id="gradSemi" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%"  stopColor={COLOR_SEMI_FILL} stopOpacity={0.9} />
              <stop offset="95%" stopColor={COLOR_SEMI_FILL} stopOpacity={0.65} />
            </linearGradient>
            <linearGradient id="gradLocked" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%"  stopColor={COLOR_LOCKED_FILL} stopOpacity={0.9} />
              <stop offset="95%" stopColor={COLOR_LOCKED_FILL} stopOpacity={0.65} />
            </linearGradient>
          </defs>
