...
function KpiCard({ label, value, dotColor }: KpiCardProps) {
  return (
    <div className="flex min-w-0 items-center justify-between gap-3 rounded-lg border border-border bg-card px-3 py-2.5 sm:block sm:px-4 sm:py-3">
      ...
      <p className="shrink-0 text-base font-semibold tabular-nums text-foreground sm:mt-1 sm:text-lg">
        {value}
      </p>
    </div>
  );
